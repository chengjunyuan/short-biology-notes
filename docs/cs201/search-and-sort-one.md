...
The simplest option for Alice is store the data 'as-is'. That is, she just needs to upload her gigantic `.fasta` file and let the other scientists search for their sequences on their own. 