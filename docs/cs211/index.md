...
1. [**Introduction to Object-Oriented Programming (OOP)**](oop-intro.md)
...
2. [**Version Control with Git & GitHub**](version-control.md)
...
3. [**Clean Code, Style & Static Analysis**](clean-code.md)
...
4. [**Automated Testing & Continuous Integration (CI)**](testing-and-ci.md)
...
5. [**Project Structure & Reproducibility**](reproducibility.md)
