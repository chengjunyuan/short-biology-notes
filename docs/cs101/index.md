...
1. [**Mental Model of Programming**](mental-model.md)
...
2. [**Collections & Data Representation**](collections.md)
...
3. [**Reading, Writing, & Parsing Biological Data**](file-io.md)
...
4. [**Packages & Environment Management**](package-management.md)
